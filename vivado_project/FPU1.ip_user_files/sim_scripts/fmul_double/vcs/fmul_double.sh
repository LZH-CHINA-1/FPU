...
#
# Script generated by Vivado on Sat Aug 16 20:23:33 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fmul_double.sh
...
#
# Usage        : fmul_double.sh
#                fmul_double.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fmul_double.sh [-reset_run]
#                fmul_double.sh [-reset_log]
#                fmul_double.sh [-help]
#
...
#                script (type 'fmul_double.sh -help' for more information).
#
...
# script info
echo -e "fmul_double.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fmul_double.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fmul_double xil_defaultlib.glbl -o fmul_double_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fmul_double_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fmul_double_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fmul_double_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fmul_double.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fmul_double.sh [-help]\n\
Usage: fmul_double.sh [-step]\n\
Usage: fmul_double.sh [-lib_map_path]\n\
Usage: fmul_double.sh [-reset_run]\n\
Usage: fmul_double.sh [-reset_log]\n\
Usage: fmul_double.sh [-keep_index]\n\
Usage: fmul_double.sh [-noclean_files]\n\n\
