...
#
# Script generated by Vivado on Fri Aug 15 01:47:23 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : div_single.sh
...
#
# Usage        : div_single.sh
#                div_single.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_single.sh [-reset_run]
#                div_single.sh [-reset_log]
#                div_single.sh [-help]
#
...
#                script (type 'div_single.sh -help' for more information).
#
...
# script info
echo -e "div_single.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_single.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.div_single xil_defaultlib.glbl -o div_single_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./div_single_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key div_single_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc div_single_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_single.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_single.sh [-help]\n\
Usage: div_single.sh [-step]\n\
Usage: div_single.sh [-lib_map_path]\n\
Usage: div_single.sh [-reset_run]\n\
Usage: div_single.sh [-reset_log]\n\
Usage: div_single.sh [-keep_index]\n\
Usage: div_single.sh [-noclean_files]\n\n\
