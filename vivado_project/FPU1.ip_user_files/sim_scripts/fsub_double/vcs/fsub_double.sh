...
#
# Script generated by Vivado on Sat Aug 16 20:21:47 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fsub_double.sh
...
#
# Usage        : fsub_double.sh
#                fsub_double.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fsub_double.sh [-reset_run]
#                fsub_double.sh [-reset_log]
#                fsub_double.sh [-help]
#
...
#                script (type 'fsub_double.sh -help' for more information).
#
...
# script info
echo -e "fsub_double.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fsub_double.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fsub_double xil_defaultlib.glbl -o fsub_double_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fsub_double_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fsub_double_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fsub_double_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fsub_double.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fsub_double.sh [-help]\n\
Usage: fsub_double.sh [-step]\n\
Usage: fsub_double.sh [-lib_map_path]\n\
Usage: fsub_double.sh [-reset_run]\n\
Usage: fsub_double.sh [-reset_log]\n\
Usage: fsub_double.sh [-keep_index]\n\
Usage: fsub_double.sh [-noclean_files]\n\n\
