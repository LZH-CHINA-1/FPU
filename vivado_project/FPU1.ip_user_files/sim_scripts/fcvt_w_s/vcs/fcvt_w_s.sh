...
#
# Script generated by Vivado on Fri Aug 15 06:04:53 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fcvt_w_s.sh
...
#
# Usage        : fcvt_w_s.sh
#                fcvt_w_s.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fcvt_w_s.sh [-reset_run]
#                fcvt_w_s.sh [-reset_log]
#                fcvt_w_s.sh [-help]
#
...
#                script (type 'fcvt_w_s.sh -help' for more information).
#
...
# script info
echo -e "fcvt_w_s.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fcvt_w_s.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fcvt_w_s xil_defaultlib.glbl -o fcvt_w_s_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fcvt_w_s_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fcvt_w_s_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fcvt_w_s_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fcvt_w_s.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fcvt_w_s.sh [-help]\n\
Usage: fcvt_w_s.sh [-step]\n\
Usage: fcvt_w_s.sh [-lib_map_path]\n\
Usage: fcvt_w_s.sh [-reset_run]\n\
Usage: fcvt_w_s.sh [-reset_log]\n\
Usage: fcvt_w_s.sh [-keep_index]\n\
Usage: fcvt_w_s.sh [-noclean_files]\n\n\
