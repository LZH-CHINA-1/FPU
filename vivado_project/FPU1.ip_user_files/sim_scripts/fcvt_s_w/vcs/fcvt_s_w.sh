...
#
# Script generated by Vivado on Fri Aug 15 05:57:44 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fcvt_s_w.sh
...
#
# Usage        : fcvt_s_w.sh
#                fcvt_s_w.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fcvt_s_w.sh [-reset_run]
#                fcvt_s_w.sh [-reset_log]
#                fcvt_s_w.sh [-help]
#
...
#                script (type 'fcvt_s_w.sh -help' for more information).
#
...
# script info
echo -e "fcvt_s_w.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fcvt_s_w.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fcvt_s_w xil_defaultlib.glbl -o fcvt_s_w_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fcvt_s_w_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fcvt_s_w_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fcvt_s_w_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fcvt_s_w.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fcvt_s_w.sh [-help]\n\
Usage: fcvt_s_w.sh [-step]\n\
Usage: fcvt_s_w.sh [-lib_map_path]\n\
Usage: fcvt_s_w.sh [-reset_run]\n\
Usage: fcvt_s_w.sh [-reset_log]\n\
Usage: fcvt_s_w.sh [-keep_index]\n\
Usage: fcvt_s_w.sh [-noclean_files]\n\n\
