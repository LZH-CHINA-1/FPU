...
#
# Script generated by Vivado on Sun Aug 17 03:59:31 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fle_double.sh
...
#
# Usage        : fle_double.sh
#                fle_double.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fle_double.sh [-reset_run]
#                fle_double.sh [-reset_log]
#                fle_double.sh [-help]
#
...
#                script (type 'fle_double.sh -help' for more information).
#
...
# script info
echo -e "fle_double.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fle_double.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fle_double xil_defaultlib.glbl -o fle_double_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fle_double_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fle_double_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fle_double_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fle_double.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fle_double.sh [-help]\n\
Usage: fle_double.sh [-step]\n\
Usage: fle_double.sh [-lib_map_path]\n\
Usage: fle_double.sh [-reset_run]\n\
Usage: fle_double.sh [-reset_log]\n\
Usage: fle_double.sh [-keep_index]\n\
Usage: fle_double.sh [-noclean_files]\n\n\
