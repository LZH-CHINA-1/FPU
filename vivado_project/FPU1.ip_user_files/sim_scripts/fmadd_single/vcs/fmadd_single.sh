...
#
# Script generated by Vivado on Fri Aug 15 03:19:13 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fmadd_single.sh
...
#
# Usage        : fmadd_single.sh
#                fmadd_single.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fmadd_single.sh [-reset_run]
#                fmadd_single.sh [-reset_log]
#                fmadd_single.sh [-help]
#
...
#                script (type 'fmadd_single.sh -help' for more information).
#
...
# script info
echo -e "fmadd_single.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fmadd_single.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fmadd_single xil_defaultlib.glbl -o fmadd_single_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fmadd_single_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fmadd_single_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fmadd_single_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fmadd_single.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fmadd_single.sh [-help]\n\
Usage: fmadd_single.sh [-step]\n\
Usage: fmadd_single.sh [-lib_map_path]\n\
Usage: fmadd_single.sh [-reset_run]\n\
Usage: fmadd_single.sh [-reset_log]\n\
Usage: fmadd_single.sh [-keep_index]\n\
Usage: fmadd_single.sh [-noclean_files]\n\n\
