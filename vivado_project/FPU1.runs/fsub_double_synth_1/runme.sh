...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fsub_double_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsub_double.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsub_double.tcl
