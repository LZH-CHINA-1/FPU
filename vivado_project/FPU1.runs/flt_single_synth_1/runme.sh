...
HD_PWD='C:/Users/Lenovo/Desktop/JYD/FPU/vivado_project/FPU1.runs/flt_single_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flt_single.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flt_single.tcl
