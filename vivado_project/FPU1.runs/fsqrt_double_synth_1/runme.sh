...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fsqrt_double_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsqrt_double.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsqrt_double.tcl
