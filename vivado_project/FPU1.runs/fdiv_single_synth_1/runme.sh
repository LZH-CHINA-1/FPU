...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fdiv_single_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fdiv_single.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fdiv_single.tcl
