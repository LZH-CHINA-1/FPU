...
HD_PWD='C:/Users/Lenovo/Desktop/JYD/FPU/vivado_project/FPU1.runs/flt_double_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flt_double.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flt_double.tcl
