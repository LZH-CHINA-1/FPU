...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fcvt_s_w_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fcvt_s_w.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fcvt_s_w.tcl
