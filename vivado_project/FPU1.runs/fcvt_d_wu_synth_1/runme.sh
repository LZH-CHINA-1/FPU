...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fcvt_d_wu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fcvt_d_wu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fcvt_d_wu.tcl
