...
HD_PWD='C:/Users/Lenovo/Desktop/JYD/FPU/vivado_project/FPU1.runs/fle_single_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fle_single.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fle_single.tcl
