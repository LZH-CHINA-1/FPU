...
HD_PWD='C:/Users/Lenovo/Desktop/JYD/FPU/vivado_project/FPU1.runs/feq_double_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log feq_double.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source feq_double.tcl
