...
HD_PWD='E:/FPU/vivado_project/FPU1.runs/fcvt_w_d_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fcvt_w_d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fcvt_w_d.tcl
